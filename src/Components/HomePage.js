    ...
    {/* Main File of Home Page */}
      <div className='mt-[54px] flex justify-center w-full '>
        <div className='flex justify-center mx-auto sm:max-w-[90%] xl:max-w-[1192px] w-full '>
          <div className='py-[86px] w-full bg-[#ccfaf5] rounded-[34px] '>
              <div className='flex items-center justify-center'>
                  <div className='flex flex-col gap-[32px] -2 w-[48%] z-[1]'>
                      <p className='text-[75px] leading-[80px] font-semibold'>Maximize your business with <span className='text-[#e05d5d]'>us</span></p>
                      ...
                      <div className='text-[#ffffff] flex gap-[25px]'>
                  ...
                  <img src = {MainImg} className=' w-[44%] h-[472px]'/>
              </div>
          </div>
        </div>
      </div>
      ...
      <div className='flex flex-col items-center mt-[94px] '>
        <div className='flex flex-col gap-[32px] mx-auto w-full max-w-[1192px] '>
      ...
      <div className='flex flex-col items-center mt-[94px]'>
        <div className='flex flex-col items-center gap-[34px] mx-auto w-full max-w-[1192px] '>
          ...
          <div className='flex justify-center px-[56px] py-[112px] rounded-[90px] bg-[#ffecec] w-full '>
            <ul className='flex sm:flex-col lg:flex-row gap-[52px] ml-[8px] mb-[6px] w-[84%] sm:items-center lg:justify-between'>
              <li className='flex flex-col gap-[36px] my-[34px] sm:w-[50%] lg:w-[33] px-[18px] py-[8px] hover:scale-105 transition-all duration-500 hover:shadow-md rounded-xl'>
              ...
              <li className='flex flex-col gap-[36px] my-[34px] px-[18px] py-[8px] hover:scale-105 transition-all duration-500 hover:shadow-md rounded-xl sm:w-[50%] lg:w-[33]'>
              ...
              <li className='flex flex-col gap-[36px] my-[34px] hover:scale-105 transition-all duration-500 hover:shadow-md py-[20px] px-[18px] rounded-xl sm:w-[50%] lg:w-[33]'>
      ...
      <div className='flex flex-col items-center mt-[100px] '>
        <div className='flex flex-col items-start mx-auto w-full max-w-[1192px] z-[2]'>
          <div className="flex items-center justify-center px-[26px] w-[68px] h-[68px] bg-[#e05d5d] rounded-full border-[9px]  border-white animate-circle"/>
        </div>

        <div className='flex items-center justify-center mt-[-34px] py-[50px] h-[524px] w-full cards-section '>
