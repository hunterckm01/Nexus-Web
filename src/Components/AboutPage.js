  ...
  return (
    <div>
      ...
      <div className='w-full flex justify-center mt-[54px]'>
        <div className='flex max-w-[1192px] w-full mx-auto justify-center '>
          <div className='flex w-full justify-center p-[52px] bg-[#fffccc] rounded-[90px]'>
              ...
              <div className='flex flex-col items-end gap-[72px]  w-full'>
                <div className='h-[360px] relative w-full'>
                  ...
                  <div className='flex flex-col gap-[14px] m-auto absolute bottom-[1px] left-0 right-0'>
                    <p className='text-[50px] leading-[60px] text-center font-semibold'>Get to know more <span className='text-[#e05d5d]'>about us</span></p>
                    <p className='text-[20px] text-[#595959] leading-[40px] text-center'>We are an agency engaged in the creative industry and business, we are ready to help you to improve your business performance together with our great team</p>
                  </div>
                </div>
      ...
      <div className='w-full items-center mt-[95px]'>
        <div className='w-full max-w-[1192px] items-start flex flex-col gap-[62px] mx-auto'>
