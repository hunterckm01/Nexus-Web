...
const WorkPage = () => {
    ...
    <div>
      ...
      <div className='w-full mt-[60px] flex justify-center'>
        <div className='w-full max-w-[1152px] mx-auto flex justify-center'>
          <div className='w-full rounded-[90px] bg-[#ccffd7] '>
            <div className='my-[34px] flex flex-col items-center'>
              <div className='flex items-start justify-between gap-5 ml-[8px] mr-[8px]  w-full'>
              ...
              <div className='flex items-center justify-between gap-[20px]  w-[956px] mt-[24px] mx-[118px]'>
                ...
                <p className='text-[50px] text-black mr-[350px] text-center font-semibold'>What we <span className='text-[#e05d5d]'>do</span></p>
              </div>
              <p className='mt-[74px] w-[68%] leading-[40px] text-[#595959] text-center'>We have completed many projects from various companies in the world, we have made many of our clients feel happy and satisfied with the results we have provided</p>
              <div className='mt-[6px] flex items-start  w-full'>
                <img src = {Circle75} className=' mt-[30px] ml-[34px] h-[114px] w-[114px] '/>
                <div className='flex items-start justify-end gap-[32px]  w-full'>
                  <img src = {Polygon} className='img-animate mt-[6px] w-[196px] rounded-[14px] h-[196px]'/>
                  <div className='w-[14px] h-[14px] rounded-full bg-[#3d349d]'></div>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* OUR WORKS SECTION */}
        ...
        <div className='flex flex-col gap-[44px] mt-[110px] mr-[56px] ml-auto w-[90%] '>
          <div className='flex lg:flex-row sm:flex-col items-center lg:gap-[59px] sm:gap-[12px]'>
            <p className='text-[40px] text-black'>Latest Project</p>
            <p className='mt-[10px] text-[16px] text-[#595959] text-center'>this is the last variety of projects we have worked on</p>
          </div>
          ...
          <div className='flex flex-col gap-[104px]'>
            <div className=' w-full max-w-[1192px] bg-[#ffb039] flex md:flex-row sm:flex-col sm:gap-4 sm:items-center md:justify-between py-[56px] rounded-[30px]'>
              <div className='ml-[120px] text-white flex flex-col sm:gap-[20px] md:gap-[120px]'>
                <p className='text-[50px] font-semibold font-font2'>APPIFY</p>
                <p className='text-[25px] mt-[20px] font-semibold'>Launching website for Apps</p>
            ...
            <div className=' w-full max-w-[1192px] bg-[#20398d]  flex md:flex-row sm:flex-col sm:gap-4 sm:items-center md:justify-between py-[56px] rounded-[30px]'>
              <div className='ml-[120px] text-white flex flex-col sm:gap-[20px] md:gap-[120px]'>
                <p className='text-[50px] font-semibold font-font2 uppercase'>alveno</p>
                <p className='text-[25px] mt-[20px] font-semibold transparent'>Landing page for Website Service</p>
           ...
           {/*  */}
            <div className='flex justify-start w-full'>
              <div className='w-full max-w-[1192px] h-[580px] bg-[#ff3c53] rounded-[30px] mx-auto relative'>
                <div className='flex flex-col  sm:gap-[20px] md:gap-[120px] text-white mx-[108px] my-[108px] '>
                  ...
                  <p className='w-[30%] leading-[43px] text-[35px] font-semibold'>Website for Agency</p>
                  <div className='mt-[20px] w-[6%] h-[2px] bg-white'></div>
                </div>
                <div className='mx-auto my-auto h-[580px] flex  absolute top-0 left-0 right-0 bottom-0'>
                  ...
                  <img src = {InsightBigImg} className=' mx-auto h-[580px] my-auto absolute  top-0 -end left-0 right-0 bottom-0'/>
                </div>
              </div>
            </div>
          </div>
